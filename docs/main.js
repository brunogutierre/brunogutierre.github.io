...
FaceComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FaceComponent, selectors: [["app-face"]], decls: 13, vars: 0, consts: [[1, "face-front"], [1, "face-title"], [1, "face-pointer-cont"], [1, "bar-left"], [1, "face-pointer", "pointer-left"], [1, "face-pointer", "pointer-right"], [1, "bar-right"], [1, "profile-cont"], [1, "face-profile"], [1, "face-projects"]], template: function FaceComponent_Template(rf, ctx) { if (rf & 1) {
